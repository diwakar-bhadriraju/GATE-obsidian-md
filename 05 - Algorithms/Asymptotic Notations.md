---
title: "Asymptotic Notations for Analysis of Algorithms"
subject: "Algorithms"
topic: "Asymptotic Analysis of Algorithms"
source: "https://www.geeksforgeeks.org/dsa/types-of-asymptotic-notations-in-complexity-analysis-of-algorithms/"
...
> [!abstract] Asymptotic Notations for Analysis of Algorithms
> 
> **Subject:** `Algorithms` &nbsp;|&nbsp; **Topic:** `Asymptotic Analysis of Algorithms`
> **Source:** [GeeksforGeeks](https://www.geeksforgeeks.org/dsa/types-of-asymptotic-notations-in-complexity-analysis-of-algorithms/)

---

# Asymptotic Notations for Analysis of Algorithms

We have discussed [Asymptotic Analysis](https://www.geeksforgeeks.org/dsa/asymptotic-notation-and-analysis-based-on-input-size-of-algorithms/), and [Worst, Average](https://www.geeksforgeeks.org/dsa/worst-average-and-best-case-analysis-of-algorithms/), [and Best Cases of Algorithms](https://www.geeksforgeeks.org/dsa/worst-average-and-best-case-analysis-of-algorithms/). The main idea of asymptotic analysis is to have a measure of the efficiency of algorithms that don't depend on machine-specific constants and don't require algorithms to be implemented and time taken by programs to be compared. Asymptotic notations are mathematical tools to represent the time complexity of algorithms for asymptotic analysis.
...
![](assets/thetanotation-ecd68ca2a2.png)
Theta notation
...
![BigO](assets/AlgoAnalysis-2-f54031b45c.png)
### **Mathematical Representation of Big-O Notation:**
> O(g(n)) = { f(n): there exist positive constants c and n0 such that 0 ≤ f(n) ≤ cg(n) for all n ≥ n0 }
For example**,** Consider the case of [Insertion Sort](https://www.geeksforgeeks.org/dsa/insertion-sort-algorithm/). It takes linear time in the best case and quadratic time in the worst case. We can safely say that the time complexity of the Insertion sort is O(n2). 
...
![BigOmega](assets/AlgoAnalysis-3-25aab6f817.png)
...
**Important Links :**
- There are two more notations called [**little o and little omega**](https://www.geeksforgeeks.org/dsa/analysis-of-algorithems-little-o-and-little-omega-notations/). Little o provides a strict upper bound (equality condition is removed from Big O) and little omega provides strict lower bound (equality condition removed from big omega)
- [Analysis of Algorithms | Set 4 (Analysis of Loops)](https://www.geeksforgeeks.org/dsa/how-to-analyse-loops-for-complexity-analysis-of-algorithms/)
- [Recent Articles on analysis of algorithm.](https://www.geeksforgeeks.org/category/algorithm/analysis/)
For more details, please refer: [Design and Analysis of Algorithms](https://www.geeksforgeeks.org/dsa/analysis-of-algorithms/).
---
