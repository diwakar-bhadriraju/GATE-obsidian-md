...
> **Source:** [GeeksforGeeks](https://www.geeksforgeeks.org/maths/matrix-operations/)
...
![addition_of_matrices](assets/addition_of_matrices-4675a942d0.webp)
Matrix Addition
...
![Subtraction-of-Matrices](assets/Subtraction-of-Matrices-660-ad1e435743.webp)
Matrix Subtraction
...
For any matrix A = [aij]m×n, if we multiply the matrix A by any scalar (say k), then the scalar ismultiplied by each elementof the matrix, and this is called the scalar multiplication of matrices.
![scalar_multiplication](assets/scalar_multiplication-660-6b9541a103.webp)
...
![Matrix-Multiplication](assets/Matrix-Multiplication-660-2280f79e35.png)
...
The [transpose operation](https://www.geeksforgeeks.org/maths/transpose-of-a-matrix/) of a matrix rearranges its rows into columns and its columns into rows. For a matrix A of order m×n, denoted as A = [aij]m×n​, its transpose is represented by AT and is defined as:
> **(A)**T** **= [a**ji**]**n×m**
![transpose](assets/transpose-660-f77cdf1151.webp)
...
> **A = [ij]**n×n**and **|A| ≠ 0**
![inverse-of-a-matrix](assets/inverse-of-a-matrix-660-afbaed0ea3.webp)
Inverse of a Matrix
...
>
> Transpose of matrix A is represented as, (A)T
>
> (A)T=
>
>
...
[GeeksforGeeks](https://www.geeksforgeeks.org/maths/matrix-operations/)
