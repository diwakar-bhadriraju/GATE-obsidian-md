...
topic: "Deadlock"
source: "https://www.geeksforgeeks.org/operating-systems/introduction-of-deadlock-in-operating-system/"
...
> [!abstract] Introduction of Deadlock in Operating System
> 
> **Subject:** `Operating System` &nbsp;|&nbsp; **Topic:** `Deadlock`
> **Source:** [GeeksforGeeks](https://www.geeksforgeeks.org/operating-systems/introduction-of-deadlock-in-operating-system/)
...
4. **Circular Wait:**  set of processes are waiting for each other in a circular fashion. For example, imagine four processes **P1**, **P2**, **P3**, and **P4** and four resources **R1**, **R2**, **R3**, and **R4**.
   ![Circular wait example](assets/Screenshot-2024-10-03-170601-961e9b7a2f.png)The above image demonstrates a circular wait deadlock, here's how:
...
[GeeksforGeeks](https://www.geeksforgeeks.org/operating-systems/introduction-of-deadlock-in-operating-system/)
