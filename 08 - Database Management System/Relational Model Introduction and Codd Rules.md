...
> [!abstract] Introduction of Relational Model and Codd Rules in DBMS
> 
> **Subject:** `Database Management System` &nbsp;|&nbsp; **Topic:** `Relational Model`
> **Source:** [GeeksforGeeks](https://www.geeksforgeeks.org/dbms/introduction-of-relational-model-and-codd-rules-in-dbms/)
...
[**Relational Schema:**](https://www.geeksforgeeks.org/dbms/relation-schema-in-dbms/) Schema represents the structure of a relation.                                                                                                         
**Example:** Relational Schema of STUDENT relation can be represented as STUDENT(StudentID, Name, Age, Course).
[**Relational Instance:**](https://www.geeksforgeeks.org/dbms/difference-between-schema-and-instance-in-dbms/) The set of values present in a relationship at a particular instance of time is known as a relational instance as shown in Table .
...
```
Read more about [Relational Model.](https://www.geeksforgeeks.org/dbms/relational-model-in-dbms/)
## **RDBMS Vendors**
...
## **Relational Algebra**
It is a procedural Language. It consists of a set of operators that can be performed on relations. [Relational Algebra](https://www.geeksforgeeks.org/dbms/introduction-of-relational-algebra-in-dbms/) forms the basis for many other high-level data sub-languages like [SQL](https://www.geeksforgeeks.org/sql/sql-tutorial/) and [QBE](https://www.geeksforgeeks.org/dbms/query-by-example-qbe/). 
Relational algebra has mainly 9 types of operators.
- [UNION](https://www.geeksforgeeks.org/c/c-unions/)
- [INTERSECTION](https://www.geeksforgeeks.org/sql/sql-intersect-clause/)
- [MINUS](https://www.geeksforgeeks.org/sql/sql-minus-operator/)
- [TIMES](https://www.geeksforgeeks.org/dbms/concept-of-time-in-database/)
- [SELECTION](https://www.geeksforgeeks.org/dbms/difference-between-selection-and-projection-in-dbms/)
- [PROJECTION](https://www.geeksforgeeks.org/dbms/difference-between-selection-and-projection-in-dbms/)
- [JOIN](https://www.geeksforgeeks.org/sql/sql-join-set-1-inner-left-right-and-full-joins/)
- [DIVISION](https://www.geeksforgeeks.org/sql/sql-division/)
...
- [Inner Join](https://www.geeksforgeeks.org/sql/sql-join-set-1-inner-left-right-and-full-joins/)
- [Outer Join](https://www.geeksforgeeks.org/sql/sql-join-set-1-inner-left-right-and-full-joins/)
- [Left Outer Join](https://www.geeksforgeeks.org/sql/sql-join-set-1-inner-left-right-and-full-joins/)
- [Right Outer Join](https://www.geeksforgeeks.org/sql/sql-join-set-1-inner-left-right-and-full-joins/)
...
Codd rules were proposed by E.F. Codd which should be satisfied by the [relational model](https://www.geeksforgeeks.org/dbms/relational-model-in-dbms/). Codd's Rules are basically used to check whether DBMS has the quality to become [Relational Database Management System (RDBMS)](https://www.geeksforgeeks.org/dbms/rdbms-full-form/).These rules set basic guidelines to ensure data is stored and managed in a clear, consistent, and reliable way. But, it is rare to find that any product has fulfilled all the rules of Codd.
...
![codd_rule](assets/codd_rule-c88ac40575.webp)
Codd's Rules
> [GATE Question-2012](https://www.geeksforgeeks.org/questions/given-the-basic-er-and-relational-models-which-of/)
## Conclusion
...
[GeeksforGeeks](https://www.geeksforgeeks.org/dbms/introduction-of-relational-model-and-codd-rules-in-dbms/)
